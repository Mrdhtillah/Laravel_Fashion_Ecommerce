            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarsVogueVista">
                    <ul class="custom-navbar-nav navbar-nav ms-auto mb-2 mb-md-0">
                        ...
                        <li><a class="nav-link <?php echo $active[2] ?>" href="admin">Admin</a></li>
                ...
                <ul class="custom-navbar-cta navbar-nav mb-2 mb-md-0 ms-5">
                    ...
                    if (isset($_SESSION['user_id'])) {
                        // User is logged in
                        $userId = $_SESSION['user_id']; // Fetch user ID or name from your authentication mechanism
                    ?>
                        <li class="dropdown">
                            <a class="nav-link" href="#" data-bs-toggle="dropdown" aria-expanded="false"><?= $userId ?></a>
                            <ul class="dropdown-menu">
                                <!-- Add logout option or other user-specific links if needed -->
                                <li class="dropdown-item">
                                    <a class="nav-link dropdown-text" href="logout">Logout</a>
                                </li>
                            </ul>
                        </li>
                    <?php } else { ?>
