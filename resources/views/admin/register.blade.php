...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="../adm/assets/css/custom.css">
    <!-- End layout styles -->
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Register Admin </h3>
            </div>
            <div class="row">
              ...
              <div class="col-md-6  grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action="/admin/register" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                            <input type="password" class="form-control" name="confirmpass" id="exampleInputPassword2" placeholder="Password">
                                @error('confirmpass')
                                    <div>{{ $message }}</div>
                                @enderror
                            </div>
